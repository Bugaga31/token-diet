...
BUILTIN_PATTERNS: list[AntiPattern] = [
    ...
    AntiPattern(
        ...
        condition="продать полюс",
        alternative=(
            "Не предлагай продажу активов владельца. Ищи новые деньги, не трогая "
            "то, что уже есть. Только если владелец САМ прикажет продать — выполнить."
        ),
        severity=1.0,
    ),
