...
Все ключи — только из `.env`. В коде секретов нет — проверяет `token_diet/code_quality.py:129`.
...
*Обновлено: 2026-08-23, v3.26.0, 151 модуль, 113 тестовых файлов (1450 тестов)*
